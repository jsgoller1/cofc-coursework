...
public class BinarySearch {
	public static void main(String[] args) {
		...
		String[] sortedFruits = {"Apple", "Apricot", "Banana", "Blueberry", "Cherry", "Grape",
				"Grapefruit", "Guava", "Lemon", "Lime", "Orange", "Peach", "Pear", "Pineapple",
				"Raspberry", "Strawberry"};
		int sortedFruitsSize = sortedFruits.length;
		String[] fruitSearches = {"Nectarine", "Mango", "Guava", "Strawberry", "Kiwi", "Apple",
				"Raspberry", "Carrot", "Lemon", "Bread"};
		...
		stringResults.print(sortedFruits, sortedFruitsSize, fruitSearches, fruitSearchesSize,
				stringComparer, expectedFruitSearchResults, true);
		...
		integerResults.print(integers, integers.length, integerSearches, integerSearches.length,
