...
public class Tests {
	public static boolean testGetScoreAndSetScore() {
		...
		ArrayList<Tuple<String, Integer, Double>> testCases =
				new ArrayList<Tuple<String, Integer, Double>>(
		...
		for (var testCase : testCases) {
			...
			boolean areEqual =
					expected.isNaN() ? actual.isNaN() : (Double.compare(actual, expected) == 0);
	...
	public static boolean testGetAssignmentScores() {
		...
		ArrayList<Pair<String, HashMap<Integer, Double>>> testCases =
				new ArrayList<Pair<String, HashMap<Integer, Double>>>(Arrays.asList(
						new Pair<String, HashMap<Integer, Double>>("Homework 2", hw2Scores),
						new Pair<String, HashMap<Integer, Double>>("Midterm", midtermScores),
						new Pair<String, HashMap<Integer, Double>>("Course project",
								projectScores)));
	...
	public static boolean testGetSortedAssignmentNames() {
		...
		ArrayList<String> expected = new ArrayList<String>(Arrays.asList("Course project",
				"Final exam", "Homework 1", "Homework 2", "Homework 3", "Homework 4", "Midterm"));
	...
	public static boolean testGetSortedStudentIDs() {
		...
		ArrayList<Integer> expected = new ArrayList<Integer>(Arrays.asList(10000, 11111, 22222,
				33333, 44444, 55555, 66666, 77777, 88888, 90000, 99999));
	...
	public static boolean testGetStudentScores() {
		...
		ArrayList<Pair<Integer, HashMap<String, Double>>> testCases =
				new ArrayList<Pair<Integer, HashMap<String, Double>>>(Arrays.asList(
						new Pair<Integer, HashMap<String, Double>>(22222, student22222Scores),
