...
public class LabProgram {
    ...
    public static void main(String[] args) {
        ...
        /*
         * // Read the input line with numbers to remove inputLine = scnr.nextLine(); terms =
         * inputLine.split(" ");
         * 
         * for (Object term : terms) { double number = Double.parseDouble(term.toString());
         * System.out.println("List after removing " + number + ": "); list.remove(number);
         * printList(list); }
         */
    }
}
